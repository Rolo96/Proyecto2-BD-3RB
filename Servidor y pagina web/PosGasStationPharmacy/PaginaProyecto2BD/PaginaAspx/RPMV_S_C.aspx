...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="Button1" runat="server" Text="Generar Reporte Sucursal" OnClick="Button1_Click" />
            <br />
            <br />
            <asp:Label ID="Label2" runat="server" Text="Cajero"></asp:Label>
            <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
            <asp:Button ID="Button2" runat="server" Text="Generar Reporte Cajero" OnClick="Button2_Click" />
            <br />
            <br />
